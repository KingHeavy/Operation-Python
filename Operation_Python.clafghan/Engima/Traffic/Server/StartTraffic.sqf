...
ENGIMA_TRAFFIC_StartTraffic = {
	...
	private _possibleVehicles = [_this, "VEHICLES", ["C_AfghanCivilians_Civilian_Ural_4320_2002_01","C_AfghanCivilians_Civilian_GAZ_Black_2002_01","C_AfghanCivilians_Civilian_Gaz_Blue_2002_01","C_AfghanCivilians_Civilian_Datsun_Blue_2002_01","C_AfghanCivilians_Civilian_Datsun_Grey_2002_01","C_AfghanCivilians_Civilian_Hilux_White_2002_01","C_AfghanCivilians_Civilian_Hilux_Brown_2002_01","C_AfghanCivilians_Civilian_Lada_White_2002_01","C_AfghanCivilians_Civilian_Lada_LM_2002_01","C_AfghanCivilians_Civilian_S1230_Van_2002_01"]] call ENGIMA_TRAFFIC_GetParamValue;
	private _vehicleCount = [_this, "VEHICLES_COUNT", 6] call ENGIMA_TRAFFIC_GetParamValue;
	...
	private _areaMarkerName = [_this, "AREA_MARKER", "mkr1", "mkr2", "mkr3", "mkr4", "mkr5", "mkr6", "mkr7", "mkr8", "mkr9", "mkr10", "mkr11", "mkr12", "mkr13", "mkr14", "mkr15", "mkr16", "mkr17", "mkr18", "mkr19", "mkr20"] call ENGIMA_TRAFFIC_GetParamValue;
