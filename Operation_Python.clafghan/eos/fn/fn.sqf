...
case(isCUPU):{_gogg=["CFP_Beard","CUP_TK_NeckScarf","CUP_FR_NeckScarf","CUP_FR_NeckScarf2","CFP_Scarfbeard_green","CFP_Scarfbeard_grey","CFP_Scarfbeard_tan","CFP_Scarfbeard_white"];_unit addGoggles(selectRandom _gogg);};
...
FList=selectRandom["PersianHead_A3_01","PersianHead_A3_02","PersianHead_A3_03","GreekHead_A3_03","IG_Leader"];
...
switch(true)do{
case(isRHSRF):{
if(round(random 4)==1)then{_unit addBackpackGlobal"rhs_rpg";sleep 1;_unit addMagazine"rhs_rpg7_PG7V_mag";_unit addMagazine"rhs_rpg7_PG7V_mag";_unit addWeaponGlobal"rhs_weap_rpg7_pgo";};
switch(round(random 5))do{
case 0:{_unit addMagazines["CUP_10x_303_M",5];_unit addWeaponGlobal"CUP_srifle_LeeEnfield";};
case 1:{_unit addMagazines["rhs_30Rnd_762x39mm_tracer",3];_unit addWeaponGlobal"rhs_weap_pm63";};
case 2:{_unit addMagazines["rhs_30Rnd_545x39_AK_green",5];_unit addWeaponGlobal"rhs_weap_ak74n";};
case 3:{_unit addMagazines["rhs_100Rnd_762x54mmR_green",4];_unit addWeaponGlobal"rhs_weap_pkm";};
case 4:{_unit addMagazines["rhs_30Rnd_762x39mm_tracer",5];_unit addWeaponGlobal"rhs_weap_akms";};
...
};sleep 1;_unit addMagazine"rhs_mag_rgd5";_unit linkItem"TFAR_pnr1000a";};
InsAI={
private["_unit"];
_unit=_this select 0;
sleep 8;
