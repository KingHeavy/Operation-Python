...
_gun="";
switch(true)do{
case(isCUPW):{_gunArr=["CUP_hgun_SA61","rhs_weap_akms","CUP_hgun_MicroUzi","rhs_weap_makarov_pm"];};
...
_grp setBehaviour"AWARE";_unit setCombatMode"YELLOW";_unit disableAI"cover";_unit disableAI"suppression";_unit enableAI"weaponAim";_unit enableAI"aimingError";
_unit forceSpeed 3;_unit lookAt _victim;
if(animationState _unit in["ApanPercMstpSnonWnonDnon_G01","ApanPknlMstpSnonWnonDnon_G01","ApanPpneMstpSnonWnonDnon_G01"])then{[_unit,""]remoteExec["switchMove",0];};
doStop _unit;
sleep .5;
