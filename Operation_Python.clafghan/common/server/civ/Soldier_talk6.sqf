...
private _hello=str selectRandom["<t size='2' shadow='2'>Hey dude.</t>"];
private _noEnglish=selectRandom["<t size='2' shadow='2'>What's up?</t>"];
private _LineOne=str selectRandom[
	"<t size='2' shadow='2'>Fuck off, nerd.</t>"];
