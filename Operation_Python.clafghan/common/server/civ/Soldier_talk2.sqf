...
private _hello=str selectRandom["<t size='2' shadow='2'>Yo.</t>"];
private _noEnglish=selectRandom["<t size='2' shadow='2'>What's going on?</t>"];
private _LineOne=str selectRandom[
	"<t size='2' shadow='2'>Got a smoke?</t>"];
