...
private _hello=str selectRandom["<t size='2' shadow='2'>Hello sir.</t>"];
private _noEnglish=selectRandom["<t size='2' shadow='2'>What's the situation in the area?</t>"];
private _LineOne=str selectRandom[
	"<t size='2' shadow='2'>The main Taliban stronghold is located in the mountains to the east.</t>"];
private _LineTwo=str selectRandom[
	"<t size='2' shadow='2'>There are also reports of Taliban patrols to the west.</t>"];
private _LineThree=str selectRandom[
	"<t size='2' shadow='2'>Mandigara has been occupied by the enemy, however there are still civilians who are resisting the Taliban.</t>"];
private _LineFour=str selectRandom[
	"<t size='2' shadow='2'>We've heard of an man in that town who says he has very important information.</t>"];
private _LineFive=str selectRandom[
	"<t size='2' shadow='2'>Go find him in Mandigara and see what this informant has to say.</t>"];
