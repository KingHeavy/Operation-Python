...
private _hello=str selectRandom["<t size='2' shadow='2'>Hey man.</t>"];
private _noEnglish=selectRandom["<t size='2' shadow='2'>Got a smoke?</t>"];
private _LineOne=str selectRandom[
	"<t size='2' shadow='2'>Suck my dick.</t>"];
