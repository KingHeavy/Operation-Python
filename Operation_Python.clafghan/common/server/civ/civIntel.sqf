...
private _LineTwo=str selectRandom[
	"<t size='2' shadow='2'>He overheard some of the Mujahedeen talking yesterday.</t>"];
private _LineThree=str selectRandom[
	"<t size='2' shadow='2'>I believe he knows where Ayman al-Zawahriri is hiding.</t>"];
private _LineFour=str selectRandom[
	"<t size='2' shadow='2'>He works on the northern side of the village of Al-Riyal.</t>"];
private _LineFive=str selectRandom[
	"<t size='2' shadow='2'>Now what about my reward?</t>"];
