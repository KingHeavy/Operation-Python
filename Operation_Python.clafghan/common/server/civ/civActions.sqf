...
private _askIntel=str selectRandom[
	...
	"<t size='2' shadow='2'>Have you seen insurgents or heard any rumors?  We're here to bring freedom to your country!</t>",
	"<t size='2' shadow='2'>Can you help us?  We want to defeat the Taliban!</t>",
	"<t size='2' shadow='2'>If you give me some valuable information, we will give you a reward.</t>"];
private _iHaveNoIntel=str selectRandom[
	...
	"<t size='2' shadow='2'>If there were Taliban here, they're gone now.</t>",
...
private _noGiveIntel=str selectRandom[
	...
	"<t size='2' shadow='2'>You?  Need MY help?!  Go away American pig.</t>",
